...
class SelfBot(discord.Client):
    def __init__(self):
        # Using a very recent build number and user agent to try and satisfy Discord's DAVE protocol requirement
        super().__init__(
            build_number=302830,
            user_agent="Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) discord/1.0.9157 Chrome/120.0.6099.291 Electron/28.2.10 Safari/537.36"
        )
